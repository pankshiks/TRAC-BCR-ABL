...
if($_SESSION['mso_eln']['Bcr-AplArr'][1] && $_SESSION['mso_eln']['Bcr-AplArr'][4])//////find quarter plots positions
{
    ...
    $daylen = 60*60*24;
    // echo '<pre>';
   // print_R($_SESSION['mso_eln']['Bcr-AplArr'][4]);
   /// print_R($date_arr);
...
$warning_max_1 = array(0,100,9.5,3.2,0.9,0.9,0.9,0.9,0.9,0.9,0.9,0.9,0.9);
...
$maximum_qrtr=max(array_keys($quarter_arr))+1;
...
if($_SESSION['mso_eln']['Bcr-AplArr'][7] && ($_SESSION['mso_eln']['Bcr-AplArr'][8]=='0' || $_SESSION['mso_eln']['Bcr-AplArr'][8]) && ($_SESSION['mso_eln']['Bcr-AplArr'][9]=='0' || $_SESSION['mso_eln']['Bcr-AplArr'][9]))
{
    if($months[($spoint-1)])
    {
        $tmonth=$months;
...
//if($_SESSION['mso_eln']['Bcr-AplArr'][8]=='1')
//$_SESSION['mso_eln']['Bcr-AplArr'][8]='1+0';
//$_SESSION['mso_eln']['Bcr-AplArr'][9]='3';
//$_SESSION['mso_eln']['Bcr-AplArr'][9].','.($spoint-1).','.$epoint
 
  //echo $_SESSION['mso_eln']['Bcr-AplArr'][8].','.$_SESSION['mso_eln']['Bcr-AplArr'][9].','.($spoint-1).','.$epoint;
...
$txt1 = new Text("Treatment start date : ".$_SESSION['mso_eln']['Bcr-AplArr'][4]);
$txt1->SetPos(5, 100);
$txt1->SetFont(FF_FONT1,FS_BOLD);
//$txt1->SetAngle(45);
 $txt1->SetOrientation(90); // Vertical text  
$graph->AddText($txt1); 
...
$graph->legend->SetPos(0.5,0.90,'center','top');
...
//exit;
if($get_max_id)
  $graph->Stroke($path."graph/$get_max_id.png");  
else
    $graph->Stroke();
?>